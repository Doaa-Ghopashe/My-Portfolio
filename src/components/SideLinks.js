...
import {faFileText as file} from '@fortawesome/free-solid-svg-icons'
...
export default function SideLinks() {
  ...
  return (
    <div className={styles.contactlinks}>
      <ul>
        <li>
          <a href={`tel:${data.phonenumber}`} title='Phone Number'>
            <FontAwesomeIcon icon={phone} />
          </a>
        </li>
        
        <li><a href={`mailto:${data.emailaddress}`} title="Email">@</a></li>

        <li><a href={data.Resume} title='Resume' target='_blank'><FontAwesomeIcon icon={file} /></a></li>
        <br />
