...
export default function Projects() {
    ...
    <Header>
        <div className='headertext'>
            ...
            There have been many projects done using different frameworks. For some of these projects, I worked on the backend, for others, I worked on the frontend, and sometimes I worked on both the frontend and backend. 
